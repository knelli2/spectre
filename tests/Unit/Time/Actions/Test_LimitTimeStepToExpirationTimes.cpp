...
void check(const Time& start, const Time& end, const TimeDelta& time_step) {
  ...
  // The new final time should be min_exp_time - 1.e-8. To allow for
  // roundoff error, I make the check 1.e-7 here.
  CHECK((min_expiration_time - new_slab_end_value) < 1.e-7);
