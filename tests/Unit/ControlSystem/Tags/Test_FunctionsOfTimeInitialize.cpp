...
void test_functions_of_time_tag() {
...

  {
    ...
    // just static assert it here. Same below.
    ...
    // Next test construction with control systems and
    // override_functions_of_time, but the map is empty. Do same checks as if we
    ...
    // override_functions_of_time
    static_assert(
        MetavariablesNoControlSystemsReplace::override_functions_of_time);
