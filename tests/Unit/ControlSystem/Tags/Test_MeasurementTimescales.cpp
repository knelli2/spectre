...
struct Metavariables {
  ...
  // This will create 5 control systems and 3 measurements. Two measurement have
  // two control systems and one measurement has only one control system
...
void test_measurement_tag() {
  ...
  const double time_step = 0.2;
  {
    ...
    TimescaleTuner tuner4 = tuner2;
    TimescaleTuner tuner5 = tuner1;
    TimescaleTuner tuner6 = tuner1;
