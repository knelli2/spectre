...
impi_dir=/apps/anvil/external/apps/intel/cluster.2019.5/compilers_and_libraries_2019.5.281/linux/mpi/intel64/
...
if [ -f blaze/include/blaze/Blaze.h ]; then
    ...
    mkdir build
    cd build
    cmake -D BUILD_TYPE=Release -D CMAKE_INSTALL_PREFIX=$dep_dir/blaze/ ..
    make install
    # mv blaze-* include
