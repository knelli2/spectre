...
TranslationMapOptions<Dim>::TranslationMapOptions(
    variants::TaggedVariant<Explicit, FromVolFile> values_from_options) {
  if (variants::holds_alternative<Explicit>(values_from_options)) {
    auto& values = variants::get<Explicit>(values_from_options);
  ...
  } else if (variants::holds_alternative<FromVolFile>(values_from_options)) {
    auto& values_from_file = variants::get<FromVolFile>(values_from_options);
