...
auto Composition<TimeDependenceCompTag0, TimeDependenceCompTags...>::
  ...
  for (auto& time_dep : time_deps_) {
    // TODO: Add check if function of time name already exists? But this
    // shouldn't happen because all names should already be guaranteed to be
    // unique at this point (i.e. a compiler error).
