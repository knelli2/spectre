...
class Wedge final : public ShapeMapTransitionFunction {
 ...
 public:
   ...
   * the outermost wedge.
   *
   * \param overall_inner_radius Inner radius of innermost wedge
   * \param overall_outer_radius Outermost radius of outermost wedge
   * \param overall_inner_sphericity Sphericity of innermost surface of
   * innermost wedge
   * \param overall_outer_sphericity Sphericity of outermost surface of
   * outermost wedge
   * \param this_wedge_inner_radius This particular wedge's inner radius
   * \param this_wedge_outer_radius This particular wedge's outer radius
   * \param this_wedge_inner_sphericity Sphericity of this particular wedge's
   * inner surface
   * \param this_wedge_outer_sphericity Sphericity of this particular wedge's
   * outer surface
  ...
  Wedge(double overall_inner_radius, double overall_outer_radius,
        ...
        double this_wedge_inner_sphericity, double this_wedge_outer_sphericity,
