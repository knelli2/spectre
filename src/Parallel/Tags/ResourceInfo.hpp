...
struct SingletonInfo {
 ...
 private:
  // Above, -1 is a sentinel value to represent that the proc should be chosen
  // automatically
  int proc_;
  bool exclusive_;
};
...
///
/// Note: This tag requires Parallel::Tags::AvoidProc0 to be in the
/// initialization tags to avoid a conflict of options.
template <typename ParallelComponent>
