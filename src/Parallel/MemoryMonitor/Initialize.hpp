 ...
 * Also adds a tag for the GlobalCache and MutableGlobalCache as well because
 * these are chares where we may want to keep track of their size. All tags are
 * constructed by default even if we aren't monitor every component.
 */
