...
struct BothHorizons : tt::ConformsTo<protocols::Measurement> {
  template <HorizonLabel Horizon>
  struct FindHorizon : tt::ConformsTo<protocols::Submeasurement> {
   private:
    template <typename ControlSystems>
    struct Interpolator {
      static std::string name() {
        return "ControlSystem::BothHorizons::" + ah::name(Horizon);
      }
      ...
      using compute_target_points =
          intrp::TargetPoints::ApparentHorizon<Interpolator, ::Frame::Grid>;
      using post_interpolation_callback =
          intrp::callbacks::FindApparentHorizon<Interpolator, ::Frame::Grid>;
   ...
   public:
    template <typename ControlSystems>
    using interpolation_target_tag = Interpolator<ControlSystems>;
  ...
  using submeasurements = tmpl::list<FindHorizon<HorizonLabel::AhA>,
                                     FindHorizon<HorizonLabel::AhB>>;
};
}  // namespace control_system::ah
