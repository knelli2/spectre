...
#include "ControlSystem/ControlErrors/InertialCenters.hpp"
...
struct InertialCenters : tt::ConformsTo<protocols::ControlSystem> {
  static constexpr size_t deriv_order = DerivOrder;

  static std::string name() { return "InertialCenters"; }

  static std::optional<std::string> component_name(
      const size_t component, const size_t num_components) {
    ASSERT(num_components == 6,
           "InertialCenters control expects 6 components but there are "
  ...
  static_assert(
      ...
      "InertialCenters only accepts BothNSCenters measurement currently.");

  using control_error = ControlErrors::InertialCenters;
  ...
  struct process_measurement {
    ...
    static void apply(
      ...
      auto& control_sys_proxy = Parallel::get_parallel_component<
          ControlComponent<Metavariables, InertialCenters>>(cache);

      Parallel::simple_action<::Actions::UpdateMessageQueue<
          MeasurementQueue, UpdateControlSystem<InertialCenters>,
          QueueTags::Center<::domain::ObjectLabel::A, Frame::Grid>,
          QueueTags::Center<::domain::ObjectLabel::B, Frame::Grid>,
          QueueTags::Center<::domain::ObjectLabel::A, Frame::Inertial>,
          QueueTags::Center<::domain::ObjectLabel::B, Frame::Inertial>>>(
